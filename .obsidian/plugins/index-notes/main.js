    ...
    for (const note of mdFiles) {
      ...
      if (frontmatter && "tags" in frontmatter) {
        ...
        if (typeof tagsValue === "string") {
          fileTagsArray = tagsValue.split(",").map((t) => t.trim()).filter((t) => t.length > 0);
        } else if (Array.isArray(tagsValue)) {
          fileTagsArray = tagsValue.map((t) => (typeof t === "string" ? t : String(t != null ? t : "")).trim()).filter((t) => t.length > 0);
