...
> 
> *Narcigesis* is a portmanteau word, combining the words *narcissism* and *[[concepts.hermeneutics.eisegesis|Eisegesis]]*. Narcissism is “excessive interest in or admiration of oneself,” and [[concepts.hermeneutics.eisegesis|Eisegesis]] is “interpretation of a text by reading into it one’s own ideas.” ([[concepts.hermeneutics.eisegesis|Eisegesis]] is the opposite of [[concepts.hermeneutics.exegesis|Exegesis]], which is “critical explanation or interpretation of a text.”) So, narcigesis is “the explanation of the Bible in a way that shows excessive interest in oneself and prioritizes one’s own ideas.”
> [[concepts.hermeneutics.eisegesis|Eisegesis]] leads to making the text of Scripture say pretty much whatever the interpreter wants it to say and thus accords well with narcissistic attitudes. A person who mishandles a passage of Scripture by injecting his own opinions into it is practicing [[concepts.hermeneutics.eisegesis|Eisegesis]]. Going further than that, a person who interprets the passage as if it were all about him is practicing narcigesis. The same is true for a person who views Scripture as primarily applicable to his own time and his own culture.
> 
...
> 
> Of course, proper [[concepts.hermeneutics.exegesis|Exegesis]] does not allow for the insertion of oneself into the text. Proper [[concepts.hermeneutics.exegesis|Exegesis]] looks for the plain meaning of the passage and explains what the text is actually about. When we allow Scripture to speak for itself, with no narcissistic distortions, we see that the Bible’s main character is Christ. He is the hero of the story.
> 
